DG.then(function() {
    ...
    dvtk = DG.marker([43.79680575813794, 131.94746375083926]).addTo(map).bindPopup('<p>КГА ПОУ \"Дальневосточный технический колледж\"<br /> \
    г. Уссурийск<br /> \
    ул. Советская, 35<br /><br /> \
    Пн-Пт 09:00-17:00<br /> \
    Приёмная комиссия: 8 (4234) 32‒11‒44<br /> \
    <a href="https://dvtk.info/" target="_blank">dvtk.info</a></p>', {
        maxWidth: 350,
        minWidth: 320
    });
    dvtk.bindLabel('КГА ПОУ \"ДВТК\"', { static: true });

    agrtech = DG.marker([43.795291775005154, 131.94813430309298]).addTo(map).bindPopup('<p>КГА ПОУ \"Уссурийский агропромышленный колледж\"<br /> \
    г. Уссурийск<br /> \
    ул. Советская, 33<br /><br /> \
    Пн-Пт 09:00-17:00<br /> \
    Приёмная комиссия: 8 (4234) 32‒11‒44<br /> \
    <a href="https://dvtk.info/" target="_blank">dvtk.info</a></p>', {
        maxWidth: 350,
    ...
    agrtech.bindLabel('КГБ ПОУ \"УАПК\"', { static: true });
